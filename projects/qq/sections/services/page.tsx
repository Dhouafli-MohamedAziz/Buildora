...
import { ChefHat, Truck, Salad, Wine } from 'lucide-react';
  ...
  const services = [
    {
      ...
      description: "Plats raffinés préparés par nos chefs étoilés avec des ingrédients locaux de saison.",
      icon: <ChefHat className="w-10 h-10" />
    },
    {
      id: 2,
      title: "Livraison Rapide",
      description: "Service de livraison express pour déguster nos spécialités chez vous en moins de 30 minutes.",
      icon: <Truck className="w-10 h-10" />
    },
    {
      id: 3,
      title: "Menu Healthy",
      description: "Options saines et équilibrées pour ceux qui surveillent leur alimentation sans compromis sur le goût.",
      icon: <Salad className="w-10 h-10" />
    },
    {
      id: 4,
      title: "Cave à Vin",
      description: "Sélection exceptionnelle de vins pour accompagner parfaitement chaque plat.",
